      ...
      <Layout pageTitle="Digvijay — Developer, Maker" description="My Personal Blog">
        ...
        <div className="main-div main-text">
          <p style={{
            fontSize: "20px",
            lineHeight: "1.6"
          }}>Hey! I'm <a href="https://twitter.com/novadigvijay" target="_blank" rel="noopener"><span style={InlineLinksStyle}>Digvijay</span></a>. I write code, design UX and build products. Currently, I am working on <a href="https://kotaru.io" target="_blank" rel="noopener"><span style={InlineLinksStyle}>Kotaru</span></a>, a platform to share your personal notes with ease. 
          {/* Browse through my <a href="#projects"><span style={InlineLinksStyle}>projects</span></a> mentioned below. */}
          </p>
          <p className="main-text" style={{
            fontSize: "20px",
            lineHeight: "1.6"
          }}>
            I am interested in tech, startups, humans, evolution & philosophy and would love to have a chat around that. I have been sharing my notes at <Link href="/notes"><span style={InlineLinksStyle}>/notes</span></Link>.
          </p>
          {/* <p style={{
            fontSize: "26px",
            lineHeight: "1.6"
