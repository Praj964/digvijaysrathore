...
about the subject.
3. Resume/ start learning outside the classroom/curriculums.
4. Connect the dots between multiple concepts/disciplines. Smart folks combine interests.
5. Go both deep and wide.
6. Make friends and share notes, talk a lot (often not encouraged in schools).    
7. Do extra research.
